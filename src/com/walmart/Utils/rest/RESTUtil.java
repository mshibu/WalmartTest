package com.walmart.Utils.rest;
...
//    private JSONArray jsonArray;
    ...
    private void get(String resource, String api, String contentType, String accept, String authorization) throws Exception {
       //  request = new HttpGet(_configuration.BaseURI + resource);
        request = new HttpGet(getUri() + resource + api);
        if (contentType != null)
    ...
    public void getJSONArray(String resource, String api) throws Exception{
            get(resource, api,  null, "application/json", null);
            String json = IOUtils.toString(response.getEntity().getContent());
            JSONArray jsonArray = new JSONArray(json);
            setJson(new JSONWrapper(jsonArray));
    }

    public void getJSONEntity(String resource, String api) throws Exception {
